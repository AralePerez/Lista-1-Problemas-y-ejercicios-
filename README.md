...
El documento fue desarrollado en **LaTeX**, utilizando notación matemática formal y demostraciones estructuradas.
...
Se estudian y demuestran propiedades como:
...
También se demuestra por inducción:
...
Reforzar la comprensión de:

- Teoría de Lenguajes Formales  
- Propiedades algebraicas de lenguajes  
- Demostraciones matemáticas  
- Aplicación de inducción matemática  

Este material es útil para cursos de:
